...
class ST_Attn(object):
    ...
    def _encoderlayer(self, x, idx):
        ...
        with tf.variable_scope('encoderlayer'):
            # attention
            state_s_ = self._spatialAttn(x_s, x_s, x_s, reuse=(idx!=0))
            ...
            # feedforward
            state_s_= self._positionwisefeedforward(state_s_, idx=idx)
    ...
    def _decoderlayer(self, y, state, idx):
        ...
        with tf.variable_scope('decoderlayer'):
            ...
            with tf.variable_scope('EA'):
                # encoder-attention
                y_s_ = self._spatialAttn(y_s, state_s, state_s, reuse=(idx!=0))
            ...
            # feedforward
            y_s_ = self._positionwisefeedforward(y_s_, idx=idx)
    ...
    def _positionwisefeedforward(self, x_s, idx):
    ...
    def build_model(self):
        ...
        with tf.variable_scope('ST-Attn'):
            ...
            # encoder-decoder
            state = self._encoder(x_s)
            y_s = self._decoder(state)
